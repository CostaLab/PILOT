...
def extend_stats(all_stats: pd.DataFrame = None,
    ...
    all_stats_extend = all_stats_extend.append(all_stats[['gene', 'cluster', 'waldStat', 'df', 'pvalue', 'FC']])
...
def infer_gene_cluster_differentiation(gene_list: list = None,
    ...
    plot_stats_by_pattern(cluster_names, all_stats_extend, gene_dict, pline, path_to_results, file_name)
